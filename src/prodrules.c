...
/*Sets up the rules for the second rsa*/
void set_rules_rsa_2(RSA* rsa) { 
    ...
    */
    ...
    {
        Token r2_token; //initial
        initialize_token(&r2_token, NULL, NON_TERMINAL_STARTING_CAT); 
    

        int token_list_len = 3; 
        Token* token_list = (Token*)malloc(sizeof(Token) * token_list_len); 

        initialize_token(&token_list[0], NULL, NON_TERMINAL_STARTING_CAT); 

        char* plus_str = (char*)malloc(sizeof(char) * 2); 
        strcpy(plus_str, "+"); 
        initialize_token(&token_list[1], plus_str, NUMERIC_OPERAND_CAT); 
    ...
    {
        Token r3_token; //initial
        initialize_token(&r3_token, NULL, NON_TERMINAL_STARTING_CAT); 
    ...
    {
        Token r6_token; //initial
        initialize_token(&r6_token, NULL, NON_TERMINAL_FACTOR_CAT); 
        ...
        initialize_token(&token_list[1], NULL, NON_TERMINAL_STARTING_CAT); 
    ...
    {
        Token r7_token; //initial
        initialize_token(&r7_token, NULL, NON_TERMINAL_FACTOR_CAT); 
